...
public class EmployeeDAOTest {
	...
	@Test
	public void testFindEmployeeByNameLastNameDepartment() {

		try {
			//
			List<Employee> emps = employeeDAO.findEmployeesByNameLastNameDepartment("Rodrigo", "Ramos", "100");
	...
	public void testFindEmployeeByName() {
		...
		try {
			//
			List<Employee> emps = employeeDAO.findEmployeesByName("Rodrigo");
	...
	public void testFindEmployeeByLastName() {
		...
		try {
			//
			List<Employee> emps = employeeDAO.findEmployeesByLastName("Romero");
	...
	public void testFindEmployeeByLogin() {
		...
		try {
			//
			Employee emp = employeeDAO.findEmployeeByLogin("jgomez19");

			Assert.assertEquals("456", emp.getPassword());
